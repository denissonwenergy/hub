...
function processEnergy()
{
    ...
    foreach ($results as $result) {
        ...
        foreach ($data_ as $data) {
            ...
            echo "Site:{$cont} - Medidor: {$meter_serial_number} / {$meter_description} - Porta RS485: {$port_rs485} - Instante: {$instante} - Energia Ativa: {$api_energy_active_full} - Energia Reativa: {$api_energy_reactive_full} - Demanda Ativa: {$api_demand_active_full} - Demanda Reativa: {$api_demand_reactive_full}" . PHP_EOL;
